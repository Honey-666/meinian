...
public class MessageConstant {
    ...
    public static final String DELETE_SETMEAL_LIST_SUCCESS = "删除套餐列表数据成功";
    public static final String DELETE_SETMEAL_LIST_FAIL = "删除套餐列表数据失败";
    public static final String EDIT_SETMEAL_SUCCESS = "删除套餐列表数据成功";
    public static final String EDIT_SETMEAL_FAIL = "删除套餐列表数据失败";
    public static final String EXCEL_UPLOAD_SUCCESS = "Excel上传成功";
    public static final String EXCEL_UPLOAD_FAIL = "Excel上传失败";
    public static final String EXPORT_BUSINESS_REPORT_FAIL = "Excel导出失败";
    public static final String EXPORT_BUSINESS_REPORT_SUCCESS = "Excel导出成功";
    public static final String QUERY_ADDRESS_SUCCESS = "查询分校地址成功";
    public static final String QUERY_ADDRESS_FAIL = "查询分校地址失败";
    public static final String ADD_ADDRESS_FAIL = "添加分校地址失败";
    public static final String ADD_ADDRESS_SUCCESS = "添加分校地址成功";
    public static final String DELETE_ADDRESS_SUCCESS = "删除分校地址成功";
    public static final String DELETE_ADDRESS_FAIL = "删除分校地址失败";
